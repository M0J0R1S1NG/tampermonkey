    ...
    for (const i of appts1.keys()) {
        ...
        if (!appts1[i].getElementsByClassName("reason_13")[0]){
            ...
            if (!appStatus.includes('No Show') && !appStatus.includes('Cancelled') && !appStatus.includes('Rebooked') && !innerht.includes('Team:') && !innerht.includes(':DR ') && !innerht.includes(':DR.')){
                ...
                if (innerht.includes('12-14') || innerht.includes('12 weeks') || innerht.includes('Lami - Day 2') || innerht.includes('D&C' ) || innerht.includes('TA' || innerht.includes('LR'  ) && (innerht.includes('CU')==0 && innerht.includes('BETA')==0 && innerht.includes('CHUP')==0 && innerht.includes('CHECK UP')==0 && innerht.includes('Follow')==0 && innerht.includes('CU')==0))) {Surgicals+=1;}
